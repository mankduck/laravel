                ...
                <div class="col-lg-5">
                    <div class="panel-head">
                        ...
                        <div class="panel-description">
                            <p>Bạn đang muốn xóa nhóm khách hàng có tên là: <span
                                    class="text-danger">{{ $customerCatalogue->name }}</span></p>
                            <p>Lưu ý: Không thể khôi phục nhóm khách hàng sau khi xóa. Hãy chắc chắn bạn muốn thực hiện chức
                                năng này</p>
                        </div>
                    </div>
                </div>
