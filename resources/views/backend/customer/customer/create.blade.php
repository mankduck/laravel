                ...
                <div class="col-lg-7">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            @php
                                $customerCatalogue = ['[Chọn nhóm thành viên]', 'Quản trị viên', 'Cộng tác viên'];
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        ...
                                        <input type="text" name="address"
                                            value="{{ old('addresss', $customer->address ?? '') }}" class="form-control"
                                            placeholder="" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb15">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-row">
                                        <label for="" class="control-label text-left">Nguồn khách hàng <span
                                                class="text-danger">(*)</span></label>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <select name="publish" class="form-control setupSelect2" id="">
                                            @foreach (__('messages.publish') as $key => $val)
                                                <option
                                                    {{ $key == old('publish', isset($customer->publish) ? $customer->publish : '') ? 'selected' : '' }}
