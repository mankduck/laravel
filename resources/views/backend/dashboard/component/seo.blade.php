<div class="ibox">
    ...
    <div class="ibox-content">
        <div class="seo-container">
            ...
            <div class="canonical">{{ (old('canonical', ($model->canonical) ?? '')) ? config('app.url').old('canonical', ($model->canonical) ?? '').config('apps.general.suffix') :  "https://duong-dan-cua-ban.html"  }}</div>
