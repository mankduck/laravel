                                    ...
                                    <div class="menu-translate-item">
                                        <div class="row">
                                            <div class="col-lg-12 mb10">
                                                <div class="text-danger">Menu: {{ $val->position }}</div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-row">
                                                    <input type="text" value="{{ $val->translate_name ?? '' }}"
                                                        name="translate[name][]" class="form-control" placeholder=""
                                                        autocomplete="off">
                                                </div>
                                                <div class="form-row">
                                                    <input type="text" value="{{ $val->translate_canonical ?? '' }}"
                                                        name="translate[canonical][]" class="form-control" placeholder=""
                                                        autocomplete="off">
                                                    <input type="hidden" value="{{ $val->id ?? '' }}"
                                                        name="translate[id][]" class="form-control" placeholder=""
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
